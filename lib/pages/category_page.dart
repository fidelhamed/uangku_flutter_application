...
class _CategoryPageState extends State<CategoryPage> {
  ...
  Future insert(String name, int type) async {
    ...
    final row = await database.into(database.categories)
      .insertReturning(CategoriesCompanion
      .insert(name: name, type: type, createdAt: now, updatedAt: now));
  ...
  Future update(int categoryId, String newName) async {
    return await database.updateCategoryUpdate(categoryId, newName);
  }
                      ...
                      return Padding(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(snapshot.data![index].name, style: GoogleFonts.montserrat(),)
                          ),
                        ),
                      );
                    });
